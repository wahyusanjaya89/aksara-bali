...
public class KonversiHrf_P {
    ...
    public KonversiHrf_P(int xIndeksHrfKonversi, int xIndeksHurufKe, char[] xTempKalimat, String[] xTempHasilKonversi) {
        this.indexHrfKonversi = 0;
        this.indeksHuruf = 0;
        this.gantungan = false;
        this.cecek = false;
    ...
    public void konversi_P() {
        if (this.indeksHuruf == 0) {
            this.tempHasilKonversi[this.indexHrfKonversi] = "p";
            ...
            if (this.cjh.cekJenisHurufVokal(this.tempKalimat[this.indeksHuruf - 2]) || this.cecek || this.tempKalimat[this.indeksHuruf - 2] == 'h' || this.tempKalimat[this.indeksHuruf - 2] == 'r') {
                ...
                this.tempHasilKonversi[this.indexHrfKonversi] = "\u00e6";
                this.indexHrfKonversi++;
                this.gantungan = false;
            } else {
