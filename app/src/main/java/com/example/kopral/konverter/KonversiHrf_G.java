...
public class KonversiHrf_G {
    ...
    public KonversiHrf_G(int xIndeksHrfKonversi, int xIndeksHurufKe, char[] xTempKalimat, String[] xTempHasilKonversi) {
        this.indexHrfKonversi = 0;
        this.indeksHuruf = 0;
        this.gantungan = false;
        this.cecek = false;
    ...
    public void konversi_G() {
        if (this.indeksHuruf == 0) {
            this.tempHasilKonversi[this.indexHrfKonversi] = "g";
            ...
            if (this.cjh.cekJenisHurufVokal(this.tempKalimat[this.indeksHuruf - 2]) || this.cecek || this.tempKalimat[this.indeksHuruf - 2] == 'h' || this.tempKalimat[this.indeksHuruf - 2] == 'r') {
                ...
                this.tempHasilKonversi[this.indexHrfKonversi] = "\u00e1";
                this.indexHrfKonversi++;
                this.gantungan = true;
            } else {
