...
public class KonversiHrf_I {
    ...
    public KonversiHrf_I(int xIndeksHrfKonversi, int xIndeksHurufKe, char[] xTempKalimat, String[] xTempHasilKonversi) {
        this.indexHrfKonversi = 0;
        this.indeksHuruf = 0;
        this.cecek = false;
        this.gantungan = false;
    ...
    public void konversi_I() {
        if (this.indeksHuruf == 0) {
            this.tempHasilKonversi[this.indexHrfKonversi] = "hi";
            this.indexHrfKonversi++;
            ...
            if (this.tempKalimat[this.indeksHuruf - 1] == ' ') {
                ...
                this.tempHasilKonversi[this.indexHrfKonversi] = "\u00c0i";
                this.indexHrfKonversi++;
            } else if (this.cjh.cekJenisHurufVokal(this.tempKalimat[this.indeksHuruf - 1]) || this.cecek) {
                this.tempHasilKonversi[this.indexHrfKonversi] = "hi";
                this.indexHrfKonversi++;
            } else {
                this.tempHasilKonversi[this.indexHrfKonversi] = "i";
                this.indexHrfKonversi++;
            }
        }
    }
