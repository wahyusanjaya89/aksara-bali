...
public class KonversiHrf_C {
    ...
    public KonversiHrf_C(int xIndeksHrfKonversi, int xIndeksHurufKe, char[] xTempKalimat, String[] xTempHasilKonversi) {
        this.indexHrfKonversi = 0;
        this.indeksHuruf = 0;
        this.gantungan = false;
        this.cecek = false;
    ...
    public void konversi_C() {
        if (this.indeksHuruf == 0) {
            this.tempHasilKonversi[this.indexHrfKonversi] = "c";
            ...
            if (this.cjh.cekJenisHurufVokal(this.tempKalimat[this.indeksHuruf - 2]) || this.cecek || this.tempKalimat[this.indeksHuruf - 2] == 'h' || this.tempKalimat[this.indeksHuruf - 2] == 'r') {
                ...
                this.tempHasilKonversi[this.indexHrfKonversi] = "\u00c7";
                this.indexHrfKonversi++;
                this.gantungan = true;
            } else {
